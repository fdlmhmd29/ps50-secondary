...
const styles = {
  banner: {
    ...
    container: {
      ...
      width: ["100%", "100%", "100%", "100%", "57%", "60%", "68%", "60%"],
      pt: ["83px", "108px", null, "109px", "0px", "150px", "0px", "0px"],
      pb: ["0px", "0px", "0px", "31px", "0px", "90px", "0px", "0px"],
      px: ["24px", "34px", null, "31px", "0px", "70px", "0px", "0px"],
    },

    // Content Box
    contentBox: {
      width: ["100%", "100%", "100%", null, "57%", "60%", "68%", "60%"],
      textAlign: "left",
      mr: ["0px", "0px", null, "25px", "0px", "150px", "0px", "0px"],
  ...
  text: {
    ...
    heading: {
      ...
      color: "white",
      width: ["100%", "100%", "100%", null, "57%", "60%", "68%", "60%"],
      mb: ["25px", "25px", null, "25px", "0px", "150px", "0px", "0px"],
    },
    content: {
      textAlign: "left",
      color: "white",
